...
//                     <div className="">
//                         <AllSingleProjectSkeleton />
//                     </div>

//                     {
//                         allProjects?.filter(project => project.state === "normal").map((project, index) => (
//                             <AllSingleProject key={index} allProjects={allProjects} setAllProjects={setAllProjects} project={project} index={index} />
//                         ))
//                     }
...
const AllProjects = ({ showDetails, setShowDetails, createdProject, setAllProjects, allProjects }) => {
    ...
    useEffect(() => {
        if (!accountDetails?.email) return; // prevent early call
